...
private:
  ...
  bool popQueuedLightUpdate(int &idx);
  void requestFullRelight(int debounceTicks);
  ...
  bool m_fullRelightPending = false;
  int m_relightDebounceTicks = 0;
  int m_relightCooldownTicks = 0;
